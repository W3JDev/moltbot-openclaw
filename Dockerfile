...
# Use a known working version that supports the current configuration
RUN npm install -g clawdbot@2026.1.24-2 \
    && clawdbot --version \
    && which clawdbot
...
# Copy startup script
# Build cache bust: 2026-02-02-v28-fix-exit-code-1
